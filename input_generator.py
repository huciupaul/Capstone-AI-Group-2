...
# # Simulate :: generate results
# store_idx = 0
# for step, t in enumerate(np.arange(0.0, 3000.0, dt)):
#     u_hat += dt * ks.dynamics(u_hat)
...
# write_h5("D:\ml_midterm\Endterm\Capstone-AI-Group-2\Generated_data.h5", u_field_all, K, D)



# # Verify the shapes of the stored arrays
# print(f"D shape: {D.shape}, time shape: {time.shape}, u_field_all shape: {u_field_all.shape}")
    

with h5py.File("D:\ml_midterm\Endterm\Capstone-AI-Group-2\Generated_data.h5", "r") as h5file:
...
plt.plot(dissipation, label="Dissipation Rate")
plt.xlabel("Time")
