...
**Thus, the (revised) requirement M3 is fulfilled: Must reconstruct the full flow feature from the latent space with a reconstruction error (normalized root-mean-squared error, NRMSE) below 25%.**
