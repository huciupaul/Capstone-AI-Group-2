...
def encodeclustering(n_lat: int) -> None:
    """
    ...
    """
    # Load encoder
    enc_path: str = f'./Data/48_RE40_{n_lat}'  # Path to the saved encoder model
    enc_mods = load_encoder(enc_path, n_lat)

    # Path to the dataset
    data_path: str = r"C:\Users\Rafael Ribeiro\Desktop\Capstone\Main Folder\Capstone-AI-Group-2\CAE\data\Generated_data_96000.h5"
    ...
    batch_size: int = 200
    n_batch: int = len(U) // batch_size  # Number of full batches
    ...
    enc_file: str = f'./data/48_Encoded_data_Re40_{n_lat}_23_1.h5'
